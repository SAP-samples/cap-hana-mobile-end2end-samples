...
open class MembersSkills: EntityValue {
    ...
    private static var id_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "ID")

    private static var createdAt_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "createdAt")

    private static var createdBy_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "createdBy")

    private static var modifiedAt_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "modifiedAt")

    private static var modifiedBy_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "modifiedBy")

    private static var memberID_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "member_ID")

    private static var skillID_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "skill_ID")

    private static var memberIDID_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "member_ID_ID")

    private static var skillIDID_: Property = EntityContainerMetadata.EntityTypes.membersSkills.property(withName: "skill_ID_ID")

    public init(withDefaults: Bool = true, withIndexMap: SparseIndexMap? = nil) {
        super.init(withDefaults: withDefaults, type: EntityContainerMetadata.EntityTypes.membersSkills, withIndexMap: withIndexMap)
    }

    open class func array(from: EntityValueList) -> [MembersSkills] {
        return ArrayConverter.convert(from.toArray(), [MembersSkills]())
    }
    ...
    open var memberID: Members? {
        get {
            return CastOptional<Members>.from(self.optionalValue(for: MembersSkills.memberID))
        }
        set(value) {
