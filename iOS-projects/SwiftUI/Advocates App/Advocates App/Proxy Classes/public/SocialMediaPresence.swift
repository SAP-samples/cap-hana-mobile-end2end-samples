...
open class SocialMediaPresence: EntityValue {
    ...
    private static var id_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "ID")

    private static var createdAt_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "createdAt")

    private static var createdBy_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "createdBy")

    private static var modifiedAt_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "modifiedAt")

    private static var modifiedBy_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "modifiedBy")

    private static var name_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "name")

    private static var url_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "url")

    private static var member_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "member")

    private static var memberID_: Property = advocatesServiceMetadata.EntityTypes.socialMediaPresence.property(withName: "member_ID")

    public init(withDefaults: Bool = true, withIndexMap: SparseIndexMap? = nil) {
        super.init(withDefaults: withDefaults, type: advocatesServiceMetadata.EntityTypes.socialMediaPresence, withIndexMap: withIndexMap)
    }

    open class func array(from: EntityValueList) -> Array<SocialMediaPresence> {
        return ArrayConverter.convert(from.toArray(), Array<SocialMediaPresence>())
    }
