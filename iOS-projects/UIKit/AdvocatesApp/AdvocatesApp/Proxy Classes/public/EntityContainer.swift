...
open class EntityContainer<Provider: DataServiceProvider>: DataService<Provider> {
    ...
    open func fetchMember(matching query: DataQuery? = nil, headers: HTTPHeaders? = nil, options: RequestOptions? = nil) throws -> [Member] {
        ...
        return try Member.array(from: self.executeQuery(var_query.fromDefault(EntityContainerMetadata.EntitySets.member), headers: var_headers, options: var_options).entityList())
    }

    open func fetchMembers(matching query: DataQuery = DataQuery(), headers: HTTPHeaders? = nil, options: RequestOptions? = nil, completionHandler: @escaping ([Member]?, Error?) -> Void) {
    ...
    open func fetchMember1(matching query: DataQuery, headers: HTTPHeaders? = nil, options: RequestOptions? = nil) throws -> Member {
        let var_headers = HTTPHeaders.emptyIfNull(headers: headers)
        let var_options = RequestOptions.noneIfNull(options: options)
        return try CastRequired<Member>.from(self.executeQuery(query.fromDefault(EntityContainerMetadata.EntitySets.member), headers: var_headers, options: var_options).requiredEntity())
    }

    open func fetchMember1(matching query: DataQuery, headers: HTTPHeaders? = nil, options: RequestOptions? = nil, completionHandler: @escaping (Member?, Error?) -> Void) {
        self.addBackgroundOperationForFunction {
            do {
    ...
    open func fetchMember1WithKey(id: GuidValue?, query: DataQuery?, headers: HTTPHeaders? = nil, options: RequestOptions? = nil, completionHandler: @escaping (Member?, Error?) -> Void) {
        self.addBackgroundOperationForFunction {
            do {
