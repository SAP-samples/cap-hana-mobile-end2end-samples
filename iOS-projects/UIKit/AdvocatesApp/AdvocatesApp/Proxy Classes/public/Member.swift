...
open class Member: EntityValue {
    ...
    private static var id_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "ID")

    private static var createdAt_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "createdAt")

    private static var createdBy_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "createdBy")

    private static var modifiedAt_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "modifiedAt")

    private static var modifiedBy_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "modifiedBy")

    private static var firstName_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "firstName")

    private static var lastName_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "lastName")

    private static var title_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "title")

    private static var focusArea_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "focusArea")

    private static var skills_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "skills")

    private static var socialMedia_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "socialMedia")

    private static var description_: Property = EntityContainerMetadata.EntityTypes.member.property(withName: "description")

    public init(withDefaults: Bool = true, withIndexMap: SparseIndexMap? = nil) {
        super.init(withDefaults: withDefaults, type: EntityContainerMetadata.EntityTypes.member, withIndexMap: withIndexMap)
    }

    open class func array(from: EntityValueList) -> [Member] {
        return ArrayConverter.convert(from.toArray(), [Member]())
    }
    ...
    open var skills: [MembersSkills] {
        get {
            return ArrayConverter.convert(Member.skills.entityList(from: self).toArray(), [MembersSkills]())
        }
        set(value) {
            Member.skills.setEntityList(in: self, to: EntityValueList.fromArray(ArrayConverter.convert(value, [EntityValue]())))
        }
    }
    ...
    open var socialMedia: [SocialMediaPresence] {
        get {
            return ArrayConverter.convert(Member.socialMedia.entityList(from: self).toArray(), [SocialMediaPresence]())
        }
        set(value) {
            Member.socialMedia.setEntityList(in: self, to: EntityValueList.fromArray(ArrayConverter.convert(value, [EntityValue]())))
        }
    }
