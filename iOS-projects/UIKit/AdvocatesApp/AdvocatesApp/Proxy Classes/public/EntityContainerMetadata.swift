...
public class EntityContainerMetadata {
    ...
    public class EntityTypes {
        private static var member_: EntityType = EntityContainerMetadataParser.parsed.entityType(withName: "AdvocatesService.Member")
        ...
        public static var member: EntityType {
            get {
                ...
                do {
                    return EntityContainerMetadata.EntityTypes.member_
                }
            }
            set(value) {
                objc_sync_enter(EntityContainerMetadata.EntityTypes.self)
                defer { objc_sync_exit(EntityContainerMetadata.EntityTypes.self) }
                do {
                    EntityContainerMetadata.EntityTypes.member_ = value
                }
            }
        }
    ...
    public class EntitySets {
        private static var member_: EntitySet = EntityContainerMetadataParser.parsed.entitySet(withName: "Member")
        ...
        public static var member: EntitySet {
            get {
                ...
                do {
                    return EntityContainerMetadata.EntitySets.member_
                }
            }
            set(value) {
                objc_sync_enter(EntityContainerMetadata.EntitySets.self)
                defer { objc_sync_exit(EntityContainerMetadata.EntitySets.self) }
                do {
                    EntityContainerMetadata.EntitySets.member_ = value
                }
            }
        }
