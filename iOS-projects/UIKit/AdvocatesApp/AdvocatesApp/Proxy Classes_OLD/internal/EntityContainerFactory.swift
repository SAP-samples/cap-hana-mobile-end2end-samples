...
internal class EntityContainerFactory {
    static func registerAll() throws {
        EntityContainerMetadata.EntityTypes.members.registerFactory(ObjectFactory.with(create: { Members(withDefaults: false) }, sparse: { m in Members(withDefaults: false, withIndexMap: m) }, decode: { d in try Members(from: d) }))
